...
import { removeTask, toggleStatus } from "@/redux/features/todoSlice";
...
const TodoCard = ({ id, title, description, isCompleted }: TTaskPros) => {
  ...
  return (
    <div className="bg-white flex justify-between items-center p-3 rounded-md border">
      <input onChange={handleToggle} type="checkbox" name="" id="" />
